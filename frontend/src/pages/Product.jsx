...
const Product = () => {
  ...
  return productData ? (
    <div className="boder-t pt-10 transition-opacity ease-in duration-500 opacity-100">
      {/* /Product Data */}
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          <h1 className="font-medium text-left text-2xl mt-2">
            {productData.name}
          </h1>
          ...
          <p className="mt-5 text-3xl text-left font-medium">
            {currency}
            {productData.price}
          </p>
          <p className="mt-5 text-left text-gray-500 md:w-4/5">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 text-sm text-gray-500">
          <p>
            lorem ispsum dolor sit amet, consectetur adipiscing elit, sed do
